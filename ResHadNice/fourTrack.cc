...
int main () {
        ...
        ofstream built;
        built.open ("BACK1/IncTrack.txt");
	std::ifstream infile0("JetTrackHad.txt");
        std::ifstream infile1("BACK1/1centA/JetTrackHad.txt");
        std::ifstream infile2("BACK1/2centA/JetTrackHad.txt");
        std::ifstream infile3("BACK1/3centA/JetTrackHad.txt");
        std::ifstream infile4("BACK1/4centA/JetTrackHad.txt");
	std::ifstream infile5("BACK1/1centB/JetTrackHad.txt");
        std::ifstream infile6("BACK1/2centB/JetTrackHad.txt");
        std::ifstream infile7("BACK1/3centB/JetTrackHad.txt");
        std::ifstream infile8("BACK1/4centB/JetTrackHad.txt");

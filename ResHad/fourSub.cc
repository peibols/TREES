...
int main () {
        ...
        ofstream built;
        built.open ("BACK1/SubTrack.txt");
	std::ifstream infile0("SubJetTrackHad.txt");
        std::ifstream infile1("BACK1/1centA/SubJetTrackHad.txt");
        std::ifstream infile2("BACK1/2centA/SubJetTrackHad.txt");
        std::ifstream infile3("BACK1/3centA/SubJetTrackHad.txt");
        std::ifstream infile4("BACK1/4centA/SubJetTrackHad.txt");
	std::ifstream infile5("BACK1/1centB/SubJetTrackHad.txt");
        std::ifstream infile6("BACK1/2centB/SubJetTrackHad.txt");
        std::ifstream infile7("BACK1/3centB/SubJetTrackHad.txt");
        std::ifstream infile8("BACK1/4centB/SubJetTrackHad.txt");

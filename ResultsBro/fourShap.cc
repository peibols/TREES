...
using namespace std;
//Arguments: Radius (2,3,4,5); BRO (0,1,2..6)
int main (int argc, char** argv) {
        assert(argc==3);

	ostringstream outF;
        ostringstream inf1, inf2, inf3, inf4, inf5, inf6, inf7, inf8, inf9, inf10;
        outF << "BRO" << argv[2] << "/Shap0" << argv[1] << ".dat";
        ofstream built;
        built.open (outF.str().c_str());
        inf1 << "BRO" << argv[2] << "/1A/ShapesRatio0" << argv[1] << ".dat";
        inf2 << "BRO" << argv[2] << "/1B/ShapesRatio0" << argv[1] << ".dat";
        inf3 << "BRO" << argv[2] << "/2A/ShapesRatio0" << argv[1] << ".dat";
        inf4 << "BRO" << argv[2] << "/2B/ShapesRatio0" << argv[1] << ".dat";
        inf5 << "BRO" << argv[2] << "/3A/ShapesRatio0" << argv[1] << ".dat";
        inf6 << "BRO" << argv[2] << "/3B/ShapesRatio0" << argv[1] << ".dat";
        inf7 << "BRO" << argv[2] << "/4A/ShapesRatio0" << argv[1] << ".dat";
        inf8 << "BRO" << argv[2] << "/4B/ShapesRatio0" << argv[1] << ".dat";

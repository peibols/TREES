...
int main (int argc, char** argv) {
        ...
        outF << "BRO" << argv[2] << "/RAA0" << argv[1] << ".dat";
        ofstream built;
        built.open (outF.str().c_str());
        inf1 << "BRO" << argv[2] << "/1A/RAA0" << argv[1] << ".dat";
	inf2 << "BRO" << argv[2] << "/1B/RAA0" << argv[1] << ".dat";
	inf3 << "BRO" << argv[2] << "/2A/RAA0" << argv[1] << ".dat";
	inf4 << "BRO" << argv[2] << "/2B/RAA0" << argv[1] << ".dat";
	inf5 << "BRO" << argv[2] << "/3A/RAA0" << argv[1] << ".dat";
	inf6 << "BRO" << argv[2] << "/3B/RAA0" << argv[1] << ".dat";
	inf7 << "BRO" << argv[2] << "/4A/RAA0" << argv[1] << ".dat";
	inf8 << "BRO" << argv[2] << "/4B/RAA0" << argv[1] << ".dat";

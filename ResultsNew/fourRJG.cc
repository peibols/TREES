...
using namespace std;
	...
	int main (int argc, char** argv) {
        ...
        inf1 << model << "/BRO" << argv[2] << "/1A/RJG3eta" << argv[3] << ".dat";
        inf2 << model << "/BRO" << argv[2] << "/2A/RJG3eta" << argv[3] << ".dat";
        inf3 << model << "/BRO" << argv[2] << "/3A/RJG3eta" << argv[3] << ".dat";
        inf4 << model << "/BRO" << argv[2] << "/4A/RJG3eta" << argv[3] << ".dat";
        inf5 << model << "/BRO" << argv[2] << "/1B/RJG3eta" << argv[3] << ".dat";
        inf6 << model << "/BRO" << argv[2] << "/2B/RJG3eta" << argv[3] << ".dat";
        inf7 << model << "/BRO" << argv[2] << "/3B/RJG3eta" << argv[3] << ".dat";
        inf8 << model << "/BRO" << argv[2] << "/4B/RJG3eta" << argv[3] << ".dat";
        inf9 << model << "/BRO" << argv[2] << "/1C/RJG3eta" << argv[3] << ".dat";
        inf10 << model << "/BRO" << argv[2] << "/2C/RJG3eta" << argv[3] << ".dat";
        inf11 << model << "/BRO" << argv[2] << "/3C/RJG3eta" << argv[3] << ".dat";
        inf12 << model << "/BRO" << argv[2] << "/4C/RJG3eta" << argv[3] << ".dat";
        inf13 << model << "/BRO" << argv[2] << "/1D/RJG3eta" << argv[3] << ".dat";
        inf14 << model << "/BRO" << argv[2] << "/2D/RJG3eta" << argv[3] << ".dat";
        inf15 << model << "/BRO" << argv[2] << "/3D/RJG3eta" << argv[3] << ".dat";
        inf16 << model << "/BRO" << argv[2] << "/4D/RJG3eta" << argv[3] << ".dat";

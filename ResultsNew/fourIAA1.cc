...
int main (int argc, char** argv) {
        ...
        outF << model << "/BRO" << argv[2] << "/IAA13" << argv[3] << ".dat";
        ofstream built;
        built.open (outF.str().c_str());

        inf1 << model << "/BRO" << argv[2] << "/1A/IAA13eta" << argv[3] << ".dat";
        inf2 << model << "/BRO" << argv[2] << "/2A/IAA13eta" << argv[3] << ".dat";
        inf3 << model << "/BRO" << argv[2] << "/3A/IAA13eta" << argv[3] << ".dat";
        inf4 << model << "/BRO" << argv[2] << "/4A/IAA13eta" << argv[3] << ".dat";
        inf5 << model << "/BRO" << argv[2] << "/1B/IAA13eta" << argv[3] << ".dat";
        inf6 << model << "/BRO" << argv[2] << "/2B/IAA13eta" << argv[3] << ".dat";
        inf7 << model << "/BRO" << argv[2] << "/3B/IAA13eta" << argv[3] << ".dat";
        inf8 << model << "/BRO" << argv[2] << "/4B/IAA13eta" << argv[3] << ".dat";
        inf9 << model << "/BRO" << argv[2] << "/1C/IAA13eta" << argv[3] << ".dat";
        inf10 << model << "/BRO" << argv[2] << "/2C/IAA13eta" << argv[3] << ".dat";
        inf11 << model << "/BRO" << argv[2] << "/3C/IAA13eta" << argv[3] << ".dat";
        inf12 << model << "/BRO" << argv[2] << "/4C/IAA13eta" << argv[3] << ".dat";
        inf13 << model << "/BRO" << argv[2] << "/1D/IAA13eta" << argv[3] << ".dat";
        inf14 << model << "/BRO" << argv[2] << "/2D/IAA13eta" << argv[3] << ".dat";
        inf15 << model << "/BRO" << argv[2] << "/3D/IAA13eta" << argv[3] << ".dat";
        inf16 << model << "/BRO" << argv[2] << "/4D/IAA13eta" << argv[3] << ".dat";

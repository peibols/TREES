...
using namespace std;
	...
	int main (int argc, char** argv) {
        ...
        outF << model << "/BRO" << argv[2] << "/RJG03" << argv[3] << ".dat";
        ofstream built;
        built.open (outF.str().c_str(), std::ofstream::app);

        inf1 << model << "/BRO" << argv[2] << "/1A/RJGL3eta" << argv[3] << ".dat";
        inf2 << model << "/BRO" << argv[2] << "/2A/RJGL3eta" << argv[3] << ".dat";
        inf3 << model << "/BRO" << argv[2] << "/3A/RJGL3eta" << argv[3] << ".dat";
        inf4 << model << "/BRO" << argv[2] << "/4A/RJGL3eta" << argv[3] << ".dat";
        inf5 << model << "/BRO" << argv[2] << "/1B/RJGL3eta" << argv[3] << ".dat";
        inf6 << model << "/BRO" << argv[2] << "/2B/RJGL3eta" << argv[3] << ".dat";
        inf7 << model << "/BRO" << argv[2] << "/3B/RJGL3eta" << argv[3] << ".dat";
        inf8 << model << "/BRO" << argv[2] << "/4B/RJGL3eta" << argv[3] << ".dat";
        inf9 << model << "/BRO" << argv[2] << "/1C/RJGL3eta" << argv[3] << ".dat";
        inf10 << model << "/BRO" << argv[2] << "/2C/RJGL3eta" << argv[3] << ".dat";
        inf11 << model << "/BRO" << argv[2] << "/3C/RJGL3eta" << argv[3] << ".dat";
        inf12 << model << "/BRO" << argv[2] << "/4C/RJGL3eta" << argv[3] << ".dat";
        inf13 << model << "/BRO" << argv[2] << "/1D/RJGL3eta" << argv[3] << ".dat";
        inf14 << model << "/BRO" << argv[2] << "/2D/RJGL3eta" << argv[3] << ".dat";
        inf15 << model << "/BRO" << argv[2] << "/3D/RJGL3eta" << argv[3] << ".dat";
        inf16 << model << "/BRO" << argv[2] << "/4D/RJGL3eta" << argv[3] << ".dat";

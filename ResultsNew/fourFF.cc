...
using namespace std;
	...
	int main (int argc, char** argv) {
        ...
        outF << model << "/BRO" << argv[2] << "/FFP3" << argv[3] << ".dat";
        ofstream built;
        built.open (outF.str().c_str());

        inf1 << model << "/BRO" << argv[2] << "/1A/FFP3eta" << argv[3] << ".dat";
        inf2 << model << "/BRO" << argv[2] << "/2A/FFP3eta" << argv[3] << ".dat";
        inf3 << model << "/BRO" << argv[2] << "/3A/FFP3eta" << argv[3] << ".dat";
        inf4 << model << "/BRO" << argv[2] << "/4A/FFP3eta" << argv[3] << ".dat";
        inf5 << model << "/BRO" << argv[2] << "/1B/FFP3eta" << argv[3] << ".dat";
        inf6 << model << "/BRO" << argv[2] << "/2B/FFP3eta" << argv[3] << ".dat";
        inf7 << model << "/BRO" << argv[2] << "/3B/FFP3eta" << argv[3] << ".dat";
        inf8 << model << "/BRO" << argv[2] << "/4B/FFP3eta" << argv[3] << ".dat";
        inf9 << model << "/BRO" << argv[2] << "/1C/FFP3eta" << argv[3] << ".dat";
        inf10 << model << "/BRO" << argv[2] << "/2C/FFP3eta" << argv[3] << ".dat";
        inf11 << model << "/BRO" << argv[2] << "/3C/FFP3eta" << argv[3] << ".dat";
        inf12 << model << "/BRO" << argv[2] << "/4C/FFP3eta" << argv[3] << ".dat";
        inf13 << model << "/BRO" << argv[2] << "/1D/FFP3eta" << argv[3] << ".dat";
        inf14 << model << "/BRO" << argv[2] << "/2D/FFP3eta" << argv[3] << ".dat";
        inf15 << model << "/BRO" << argv[2] << "/3D/FFP3eta" << argv[3] << ".dat";
        inf16 << model << "/BRO" << argv[2] << "/4D/FFP3eta" << argv[3] << ".dat";
